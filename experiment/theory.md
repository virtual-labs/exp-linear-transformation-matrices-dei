...
<i>αT</i>(<i>x</i>)=<i>α</i>(<i>x</i><sub>1</sub>, -<i>x</i><sub>2</sub>)=(<i>αx</i><sub>1</sub>, -<i>αx</i><sub>2</sub>). This completes this prrof. <br></span>
...
<i>αT</i>(<i>x</i>)=α(<i>x</i><sub>1</sub>, 0)=(<i>αx</i><sub>1</sub>, 0). This completes this prrof. <br></span>
...
α<i>T</i>(<i>x</i>)=α(<i>x</i><sub>2</sub>, <i>x</i><sub>1</sub>)=(<i>αx</i><sub>2</sub>, α<i>x</i><sub>1</sub>).This completes this prrof.</span>
