...
Clearly <i>T</i>(1, 0)=(1, 0)=0.(0, -1)+(-1).(-1, 0), <i>T</i>(0, 1)=(0, -1)= 1.(0, -1)+0.(-1, 0) and hence the matrix represented by <i>T</i> w.r.t. the basis <i>B</i><sub>1</sub> and <i>B</i><sub>2</sub> is A =</span> $ \begin{pmatrix}0 & 1 \\ -1 & 0 \end{pmatrix} $.
