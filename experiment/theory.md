...
$ B= \{<i>e</i><sub>1</sub>, <i>e</i><sub>2</sub>, …, <i>e</i><sub>n</sub>\} $ is a basis for $V$ and let <i>x</i>= <i>r</i><sub>1</sub><i>f</i><sub>1</sub>+<i>r</i><sub>2</sub> <i>e</i><sub>2</sub>+ ... +<i>r</i><sub>n</sub><i>e</i><sub>n</sub>,$ where <i>x</i> &isin; V, <i>r</i><sub>1</sub>, <i>r</i><sub>2</sub>, …, <i>r</i><sub>2</sub> &isin; R.$ Then $<i>T</i>(<i>e</i><sub>1</sub>), <i>T</i>(<i>e</i><sub>2</sub>), …, <i>T</i>(<i>e</i><sub>n</sub>)$ define <i>T,</i> by  $<i>T</i>(<i>x</i>)= r<i>T</i>(<i>e</i><sub>1</sub>)+s<i>T</i>(<i>e</i><sub>2</sub>)+  … +t<i>T</i>(<i>e</i><sub>n</sub>).$
