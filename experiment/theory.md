...
<span style="font-family: 'Times New Roman'; font-size: 22px;">Consider <i>A</i></span> = $ \begin{pmatrix}1 & -1 & 0 \\\ 0 & 1 & 1\end{pmatrix} $. <span style="font-family: 'Times New Roman'; font-size: 22px;">Then we find the associated linear transformation of <i>A</i> w.r.t. the bases <i>B</i><sub>1</sub>={(1, 0, 0), (-1, 1, 0), (0, 1, 1)} and <i>B</i><sub>2</sub>={(-1, 1), (0, 1)} of <i>R</i><sup>3</sup> and <i>R</i><sup>2</sup> respectively.  <br>
