    ...
    function sbmtb1(){
        ...
        document.getElementById("displayb1").innerHTML="Thus we choose basis for the domain R<sup>2</sup> as B<sub>1</sub> = {("+f11val+", "+f12val+"), ("+f21val+", "+f22val+")}";
    }
    function sbmtb2(){
        ...
        document.getElementById("displayb2").innerHTML="Thus we choose basis for the co-domain R<sup>2</sup> as B<sub>2</sub> = {("+e11val+", "+e12val+"), ("+e21val+", "+e22val+")}";
    }
    ...
    function explain(){
        ...
        document.getElementById('x1x2').innerHTML="<ul><li>Let x &equiv; (x<sub>1</sub>, x<sub>2</sub>) &isin; R<sup>2</sup> & let x = rf<sub>1</sub> + sf<sub>2</sub><br>Then r = x<sub>1</sub>, s = x<sub>2</sub></li></ul>";

        document.getElementById('tx').innerHTML="<ul><li>So that T(x) = x<sub>1</sub>T(f<sub>1</sub>) + x<sub>2</sub>T(f<sub>2</sub>)</li></ul>";
        

        document.getElementById('tf1').innerHTML="<ul><li>Define T(f<sub>1</sub>) = T("+f11val+" , "+f12val+") = "+aval+"("+e11val+" , "+e12val+") + "+cval+"("+e21val+" , "+e22val+")</li></ul>";
        document.getElementById('tf2').innerHTML="&ensp; &nbsp;&ensp; and T(f<sub>2</sub>) = T("+f21val+" , "+f22val+") = "+bval+"("+e11val+" , "+e12val+") + "+dval+"("+e21val+" , "+e22val+")";
